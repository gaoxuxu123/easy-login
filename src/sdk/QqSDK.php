...
namespace easy\auth\sdk;


use easy\auth\EasyAuth;

class QqSDK extends EasyAuth
{
    /**
     * 获取requestCode的api接口
     * @var string
     ...
     * @var srting
     */
    protected $Authorize = 'scope=get_user_info,add_share,add_pic_t';
     ...
     * @return json
     */
    public function getUserInfo($api, $param = '', $method = 'GET', $header = array(), $multi = false){
        /* 腾讯QQ调用公共参数 */
        $params = array(
        ...
        $data = $this->http($this->url($api), $this->param($params, $param), $method, $header, $multi);
